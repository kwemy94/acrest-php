    ...
    <table class="table table-bordered table-striped" >
    	...
    	<tbody>
            ...
            <tr>
            	...
            	<td><?php echo htmlspecialchars($donnee['filiere1']); ?></td>
                <td><?php echo htmlspecialchars($donnee['specialite_1']); ?></td>
                <td><?php echo htmlspecialchars($donnee['filiere2']); ?></td>
                <td><?php echo htmlspecialchars($donnee['specialite_2']); ?></td>
                <td><?php echo htmlspecialchars($donnee['filiere3']); ?></td>
                <td><?php echo htmlspecialchars($donnee['specialite_3']); ?></td>
            </tr>
        <?php } ?>
    	</tbody>
    </table>
