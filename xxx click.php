...
le code HTML :
   ...
   <div id="afficher">
      <div id="masquer">
         ...
         <p>C'est d'abord comme peintre que Léonard de Vinci est reconnu. Deux de ses œuvres, <a href="#afficher" class="afficher">La Joconde</a><a href="#masquer" class="masquer">La Joconde</a> et La Cène, sont des peintures mondialement célèbres, souvent copiées et parodiées
         </p>
      </div>
   </div>
</body>